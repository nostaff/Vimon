<template>
  <div class="ion-navbar" :class="[themeClass, colorClass]">
    ...
    <slot name="item-start">
      <ion-button role="bar-button" :class="['back-button','back-button-'+theme,'show-back-button']" :icon-only="!backText" @click.native="onBackClicked" v-if="isShowBack">
    ...
    <slot name="item-end">
      <ion-buttons v-if="showMore">
        <ion-button :icon-only="!moreText" @click.native="onMoreClicked">
...
import IonToolbar from '../toolbar'
